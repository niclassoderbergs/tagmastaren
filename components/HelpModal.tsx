  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 overflow-y-auto animate-fade-in">
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="bg-white w-full max-w-2xl rounded-3xl shadow-2xl border-4 border-indigo-300 flex flex-col relative my-8">
          
          {/* Header */}
          <div className="bg-indigo-100 p-4 flex justify-between items-center border-b-4 border-indigo-200 rounded-t-3xl">
